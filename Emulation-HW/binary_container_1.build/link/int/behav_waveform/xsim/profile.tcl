...
proc getTraceEvents {kernelName cuName moduleName signal targetValue {requireEnd 0}} {
  ...
  set startTimeMsec 0
  set factor 9.0
  set currDeviceName xilinx_zcu104_zcu104_base_1_0-0
...
# Compute Unit Stalls
#
set computeUnits { cvtcolor_bgr2hsv_1 }
...
for { set i 0 } { $i < [llength $computeUnits] } { incr i } {
  ...
  # Runtime
  set signal /zcu104_base_wrapper/zcu104_base_i/$cuName/$hierName/ap_idle
  ...
  # Stall times
  set signal /zcu104_base_wrapper/zcu104_base_i/$cuName/$hierName/ap_int_blocking_n
  set timeRange 20
  ...
  set signal /zcu104_base_wrapper/zcu104_base_i/$cuName/$hierName/ap_ext_blocking_n
  set extStallTime [lindex [getTimeUsec $signal 0] 2]
  set extStallPercent [expr {$cuTime == 0} ? 0 : min((100.0 * $extStallTime) / $cuTime, 100.0)]

  set signal /zcu104_base_wrapper/zcu104_base_i/$cuName/$hierName/ap_str_blocking_n
...
# Function Stalls
#
set computeUnits { cvtcolor_bgr2hsv_1 cvtcolor_bgr2hsv_1 cvtcolor_bgr2hsv_1 cvtcolor_bgr2hsv_1 cvtcolor_bgr2hsv_1 cvtcolor_bgr2hsv_1 }
set modules { Array2xfMat_512_9_1080_1920_1_U0 Array2xfMat_512_9_1080_1920_1_U0/grp_Axi2Mat_fu_78 xfMat2Array_512_9_1080_1920_1_U0 xfMat2Array_512_9_1080_1920_1_U0/grp_Mat2Axi_fu_56 bgr2hsv_9_1080_1920_1_U0 Block_split1_proc21_U0 }
set realModules { Array2xfMat_512_9_1080_1920_1_s Array2xfMat_512_9_1080_1920_1_s/Axi2Mat xfMat2Array_512_9_1080_1920_1_s xfMat2Array_512_9_1080_1920_1_s/Mat2Axi bgr2hsv_9_1080_1920_1_s Block_split1_proc21 }
...
for { set i 0 } { $i < [llength $computeUnits] } { incr i } {
  ...
  set cuSignal /zcu104_base_wrapper/zcu104_base_i/$cuName/$hierName/ap_idle
  set moduleSignal /zcu104_base_wrapper/zcu104_base_i/$cuName/$hierName/$moduleName/ap_idle
  ...
  # Stall times
  set signal /zcu104_base_wrapper/zcu104_base_i/$cuName/$hierName/$moduleName/ap_int_blocking_n
  set timeRange 20
  set checkTransRetList  [checkTransitions $signal $timeRange $cuStartTime $cuEndTime 1000 0]
  set isHighNumTranx     [lindex $checkTransRetList 0]
  set intStallPercent 0
  ...
  set signal /zcu104_base_wrapper/zcu104_base_i/$cuName/$hierName/$moduleName/ap_ext_blocking_n
  set extStallTime [lindex [getTimeUsec $signal 0] 2]
  set extStallPercent [expr {$cuTime == 0} ? 0 : min((100.0 * $extStallTime) / $cuTime, 100.0)]

  set signal /zcu104_base_wrapper/zcu104_base_i/$cuName/$hierName/$moduleName/ap_str_blocking_n
  set strStallTime [lindex [getTimeUsec $signal 0] 2]
  set strStallPercent [expr {$cuTime == 0} ? 0 : min((100.0 * $strStallTime) / $cuTime, 100.0)]
...
# Compute Unit Ports
#
set computeUnits { cvtcolor_bgr2hsv_1 cvtcolor_bgr2hsv_1 }
set ports { m_axi_gmem1 m_axi_gmem2 }
set readBusySignals { /zcu104_base_wrapper/zcu104_base_i/cvtcolor_bgr2hsv_1/m_axi_gmem1.readActive /zcu104_base_wrapper/zcu104_base_i/cvtcolor_bgr2hsv_1/m_axi_gmem2.readActive }
set writeBusySignals { /zcu104_base_wrapper/zcu104_base_i/cvtcolor_bgr2hsv_1/m_axi_gmem1.writeActive /zcu104_base_wrapper/zcu104_base_i/cvtcolor_bgr2hsv_1/m_axi_gmem2.writeActive }
...
# Set list of CU, modules, protoinst for kernel cvtcolor_bgr2hsv at index 0 in " kernels " list declared later 
set cuForKernel0 { cvtcolor_bgr2hsv_1  } 
set moduleForKernel0 { Array2xfMat_512_9_1080_1920_1_U0 Array2xfMat_512_9_1080_1920_1_U0/grp_Axi2Mat_fu_78 Array2xfMat_512_9_1080_1920_1_U0/grp_Axi2Mat_fu_78/AxiStream2MatStream_U0 Array2xfMat_512_9_1080_1920_1_U0/grp_Axi2Mat_fu_78/Axi2AxiStream_U0 Array2xfMat_512_9_1080_1920_1_U0/grp_Axi2Mat_fu_78/addrbound4_U0 Array2xfMat_512_9_1080_1920_1_U0/grp_Axi2Mat_fu_78/Axi2Mat_entry3_U0 Array2xfMat_512_9_1080_1920_1_U0/grp_Axi2Mat_fu_78/Axi2Mat_entry7_U0 Array2xfMat_512_9_1080_1920_1_U0/grp_Axi2Mat_fu_78/last_blk_pxl_width3_U0 Array2xfMat_512_9_1080_1920_1_U0/grp_Axi2Mat_fu_78/Axi2Mat_Block_split26_proc_U0 xfMat2Array_512_9_1080_1920_1_U0 xfMat2Array_512_9_1080_1920_1_U0/grp_Mat2Axi_fu_56 xfMat2Array_512_9_1080_1920_1_U0/grp_Mat2Axi_fu_56/Mat2AxiStream_U0 xfMat2Array_512_9_1080_1920_1_U0/grp_Mat2Axi_fu_56/Mat2AxiStream_U0/MatStream2AxiStream_U0 xfMat2Array_512_9_1080_1920_1_U0/grp_Mat2Axi_fu_56/Mat2AxiStream_U0/last_blk_pxl_width13_U0 xfMat2Array_512_9_1080_1920_1_U0/grp_Mat2Axi_fu_56/AxiStream2Axi_U0 xfMat2Array_512_9_1080_1920_1_U0/grp_Mat2Axi_fu_56/addrbound_U0 xfMat2Array_512_9_1080_1920_1_U0/grp_Mat2Axi_fu_56/Mat2Axi_entry16_U0 xfMat2Array_512_9_1080_1920_1_U0/grp_Mat2Axi_fu_56/Mat2Axi_Block_split24_proc_U0 bgr2hsv_9_1080_1920_1_U0 Block_split1_proc21_U0  } 
set protoInstForKernel0 { Array2xfMat_512_9_1080_1920_1_U0 grp_Axi2Mat_fu_78 AxiStream2MatStream_U0 Axi2AxiStream_U0 addrbound4_U0 Axi2Mat_entry3_U0 Axi2Mat_entry7_U0 last_blk_pxl_width3_U0 Axi2Mat_Block_split26_proc_U0 xfMat2Array_512_9_1080_1920_1_U0 grp_Mat2Axi_fu_56 Mat2AxiStream_U0 MatStream2AxiStream_U0 last_blk_pxl_width13_U0 AxiStream2Axi_U0 addrbound_U0 Mat2Axi_entry16_U0 Mat2Axi_Block_split24_proc_U0 bgr2hsv_9_1080_1920_1_U0 Block_split1_proc21_U0  } 

set kernels { cvtcolor_bgr2hsv }
...
for { set i 0 } { $i < [llength $kernels] } { incr i } {
  ...
  for { set j 0 } { $j < [llength $computeUnits] } { incr j } {
    ...
    for { set k 0 } { $k < [llength $modules] } { incr k } {
      ...
      set signal /zcu104_base_wrapper/zcu104_base_i/$cuName/$hierName/$modulePathName/$protoInstName.dataflowTxWaveData.OutStanding
      getTraceEvents2 $kernelName $cuName $modulePathName outstanding 0 $signal
      for { set l 0 } { $l < 64 } { incr l } {
        set signal /zcu104_base_wrapper/zcu104_base_i/$cuName/$hierName/$modulePathName/$protoInstName.iterationsWave_$l
