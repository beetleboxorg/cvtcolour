namespace eval ::optrace {
  variable script "/tools/Xilinx/Vitis/2020.1/workspace/cvtcolour/Emulation-HW/binary_container_1.build/link/vivado/vpl/vpl.tcl"
...
set rc [catch {
  ...
  dict set config_info is_disable_profile_src 1
  dict set config_info default_vimage_scripts /tools/Xilinx/Vitis/2020.1/bin/../scripts/vimage
  dict set config_info platform_dir /tools/Xilinx/Vitis/2020.1/platforms/xilinx_zcu104_base_202010_1
  dict set config_info platform_name xilinx_zcu104_base_202010_1
  dict set config_info product_dir /tools/Xilinx/Vitis/2020.1/bin/..
  dict set config_info config_name xilinx_zcu104_base_202010_1
  dict set config_info os_name linux
  dict set config_info cpu_type cortex-a53
  dict set config_info is_versal_embedded_platform 1

OPTRACE "Generate simulation scripts & compile" START { }
  dict set config_info top_bd_name ""
  dict set config_info dr_bd ""
  dict set config_info top_bd ""
