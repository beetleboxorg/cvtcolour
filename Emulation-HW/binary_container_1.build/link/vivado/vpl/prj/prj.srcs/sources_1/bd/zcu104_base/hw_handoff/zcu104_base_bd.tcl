...
proc create_hier_cell_System_DPA { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -type clk mon_clk
  create_bd_pin -dir I -type rst mon_resetn
  ...
  set_property -dict [ list \
   CONFIG.NUM_TRACE_PORTS {8} \
   CONFIG.S_AXIMM_DATA_WIDTH {32} \
 ] $dpa_hub

  # Create instance: dpa_mon0_0, and set properties
  set dpa_mon0_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:sim_aximm_perf_mon:1.0 dpa_mon0_0 ]
  set_property -dict [ list \
   CONFIG.ADDR_MAX {0x000000007FFFFFFF} \
   CONFIG.ADDR_MIN {0x0000000000000000} \
   CONFIG.CAPTURE_BURSTS {0} \
   CONFIG.COUNT_WIDTH {64} \
   CONFIG.ENABLE_ADDR_FILTER {true} \
   CONFIG.ENABLE_COUNTERS {true} \
   CONFIG.ENABLE_DEBUG {true} \
   CONFIG.ENABLE_TRACE {true} \
   CONFIG.EN_AXI_LITE {1} \
   CONFIG.MODE_SDACCEL {true} \
   CONFIG.MONITOR_ID {cvtcolor_bgr2hsv_1:m_axi_gmem1-HP0} \
   CONFIG.TRACE_READ_ID {0} \
   CONFIG.TRACE_WRITE_ID {1} \
 ] $dpa_mon0_0
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/cvtcolor_bgr2hsv_1/m_axi_gmem1-HP0} [get_bd_cells /System_DPA/dpa_mon0_0]

  # Create instance: dpa_mon0_1, and set properties
  set dpa_mon0_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:sim_aximm_perf_mon:1.0 dpa_mon0_1 ]
  set_property -dict [ list \
   CONFIG.ADDR_MAX {0x00000000DFFFFFFF} \
   CONFIG.ADDR_MIN {0x00000000C0000000} \
   CONFIG.CAPTURE_BURSTS {0} \
   CONFIG.COUNT_WIDTH {64} \
   CONFIG.ENABLE_ADDR_FILTER {true} \
   CONFIG.ENABLE_COUNTERS {true} \
   ...
   CONFIG.EN_AXI_LITE {1} \
   CONFIG.MODE_SDACCEL {true} \
   CONFIG.MONITOR_ID {cvtcolor_bgr2hsv_1:m_axi_gmem1-HP} \
   CONFIG.TRACE_READ_ID {2} \
   CONFIG.TRACE_WRITE_ID {3} \
 ] $dpa_mon0_1
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/cvtcolor_bgr2hsv_1/m_axi_gmem1-HP} [get_bd_cells /System_DPA/dpa_mon0_1]

  # Create instance: dpa_mon1_0, and set properties
  set dpa_mon1_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:sim_aximm_perf_mon:1.0 dpa_mon1_0 ]
  set_property -dict [ list \
   CONFIG.ADDR_MAX {0x000000007FFFFFFF} \
   CONFIG.ADDR_MIN {0x0000000000000000} \
   CONFIG.CAPTURE_BURSTS {0} \
   ...
   CONFIG.EN_AXI_LITE {1} \
   CONFIG.MODE_SDACCEL {true} \
   CONFIG.MONITOR_ID {cvtcolor_bgr2hsv_1:m_axi_gmem2-HP0} \
   CONFIG.TRACE_READ_ID {4} \
   CONFIG.TRACE_WRITE_ID {5} \
 ] $dpa_mon1_0
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/cvtcolor_bgr2hsv_1/m_axi_gmem2-HP0} [get_bd_cells /System_DPA/dpa_mon1_0]

  # Create instance: dpa_mon1_1, and set properties
  set dpa_mon1_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:sim_aximm_perf_mon:1.0 dpa_mon1_1 ]
  set_property -dict [ list \
   CONFIG.ADDR_MAX {0x00000000DFFFFFFF} \
   CONFIG.ADDR_MIN {0x00000000C0000000} \
   CONFIG.CAPTURE_BURSTS {0} \
   ...
   CONFIG.EN_AXI_LITE {1} \
   CONFIG.MODE_SDACCEL {true} \
   CONFIG.MONITOR_ID {cvtcolor_bgr2hsv_1:m_axi_gmem2-HP} \
   CONFIG.TRACE_READ_ID {6} \
   CONFIG.TRACE_WRITE_ID {7} \
 ] $dpa_mon1_1
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/cvtcolor_bgr2hsv_1/m_axi_gmem2-HP} [get_bd_cells /System_DPA/dpa_mon1_1]

  # Create interface connections
  connect_bd_intf_net -intf_net cvtcolor_bgr2hsv_1_m_axi_gmem1 [get_bd_intf_pins MON_M_AXI] [get_bd_intf_pins dpa_mon0_1/MON_M_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets cvtcolor_bgr2hsv_1_m_axi_gmem1] [get_bd_intf_pins MON_M_AXI] [get_bd_intf_pins dpa_mon0_0/MON_M_AXI]
  connect_bd_intf_net -intf_net cvtcolor_bgr2hsv_1_m_axi_gmem2 [get_bd_intf_pins MON_M_AXI1] [get_bd_intf_pins dpa_mon1_1/MON_M_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets cvtcolor_bgr2hsv_1_m_axi_gmem2] [get_bd_intf_pins MON_M_AXI1] [get_bd_intf_pins dpa_mon1_0/MON_M_AXI]
  ...
  connect_bd_intf_net -intf_net dpa_mon0_0_TRACE_OUT_0 [get_bd_intf_pins dpa_hub/TRACE_IN_0] [get_bd_intf_pins dpa_mon0_0/TRACE_OUT_0]
  connect_bd_intf_net -intf_net dpa_mon0_0_TRACE_OUT_1 [get_bd_intf_pins dpa_hub/TRACE_IN_1] [get_bd_intf_pins dpa_mon0_0/TRACE_OUT_1]
  connect_bd_intf_net -intf_net dpa_mon0_1_TRACE_OUT_0 [get_bd_intf_pins dpa_hub/TRACE_IN_2] [get_bd_intf_pins dpa_mon0_1/TRACE_OUT_0]
  connect_bd_intf_net -intf_net dpa_mon0_1_TRACE_OUT_1 [get_bd_intf_pins dpa_hub/TRACE_IN_3] [get_bd_intf_pins dpa_mon0_1/TRACE_OUT_1]
  connect_bd_intf_net -intf_net dpa_mon1_0_TRACE_OUT_0 [get_bd_intf_pins dpa_hub/TRACE_IN_4] [get_bd_intf_pins dpa_mon1_0/TRACE_OUT_0]
  connect_bd_intf_net -intf_net dpa_mon1_0_TRACE_OUT_1 [get_bd_intf_pins dpa_hub/TRACE_IN_5] [get_bd_intf_pins dpa_mon1_0/TRACE_OUT_1]
  connect_bd_intf_net -intf_net dpa_mon1_1_TRACE_OUT_0 [get_bd_intf_pins dpa_hub/TRACE_IN_6] [get_bd_intf_pins dpa_mon1_1/TRACE_OUT_0]
  connect_bd_intf_net -intf_net dpa_mon1_1_TRACE_OUT_1 [get_bd_intf_pins dpa_hub/TRACE_IN_7] [get_bd_intf_pins dpa_mon1_1/TRACE_OUT_1]
  connect_bd_intf_net -intf_net interconnect_axihpm0fpd_M01_AXI [get_bd_intf_pins S_AXIMM] [get_bd_intf_pins dpa_hub/S_AXIMM]
  connect_bd_intf_net -intf_net interconnect_axilite_M01_AXI [get_bd_intf_pins MON_S_AXI] [get_bd_intf_pins dpa_mon0_1/MON_S_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets interconnect_axilite_M01_AXI] [get_bd_intf_pins MON_S_AXI] [get_bd_intf_pins dpa_mon1_0/MON_S_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets interconnect_axilite_M01_AXI] [get_bd_intf_pins MON_S_AXI] [get_bd_intf_pins dpa_mon1_1/MON_S_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets interconnect_axilite_M01_AXI] [get_bd_intf_pins MON_S_AXI] [get_bd_intf_pins dpa_mon0_0/MON_S_AXI]
  connect_bd_intf_net -intf_net interconnect_axilite_M02_AXI [get_bd_intf_pins S00_AXI] [get_bd_intf_pins dpa_ctrl_interconnect/S00_AXI]

  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out4 [get_bd_pins mon_clk] [get_bd_pins dpa_ctrl_interconnect/ACLK] [get_bd_pins dpa_ctrl_interconnect/M00_ACLK] [get_bd_pins dpa_ctrl_interconnect/M01_ACLK] [get_bd_pins dpa_ctrl_interconnect/S00_ACLK] [get_bd_pins dpa_hub/axilite_clk] [get_bd_pins dpa_hub/s_aximm_clk] [get_bd_pins dpa_hub/trace_clk] [get_bd_pins dpa_mon0_0/mon_clk] [get_bd_pins dpa_mon0_0/trace_clk] [get_bd_pins dpa_mon0_1/mon_clk] [get_bd_pins dpa_mon0_1/trace_clk] [get_bd_pins dpa_mon1_0/mon_clk] [get_bd_pins dpa_mon1_0/trace_clk] [get_bd_pins dpa_mon1_1/mon_clk] [get_bd_pins dpa_mon1_1/trace_clk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins mon_resetn] [get_bd_pins dpa_ctrl_interconnect/ARESETN] [get_bd_pins dpa_ctrl_interconnect/M00_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M01_ARESETN] [get_bd_pins dpa_ctrl_interconnect/S00_ARESETN] [get_bd_pins dpa_hub/axilite_aresetn] [get_bd_pins dpa_hub/s_aximm_aresetn] [get_bd_pins dpa_hub/trace_aresetn] [get_bd_pins dpa_mon0_0/mon_resetn] [get_bd_pins dpa_mon0_0/trace_rst] [get_bd_pins dpa_mon0_1/mon_resetn] [get_bd_pins dpa_mon0_1/trace_rst] [get_bd_pins dpa_mon1_0/mon_resetn] [get_bd_pins dpa_mon1_0/trace_rst] [get_bd_pins dpa_mon1_1/mon_resetn] [get_bd_pins dpa_mon1_1/trace_rst]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: cvtcolor_bgr2hsv_1, and set properties
  ...
  connect_bd_intf_net -intf_net cvtcolor_bgr2hsv_1_m_axi_gmem1 [get_bd_intf_pins axi_ic_ps_e_S_AXI_HP0_FPD/S00_AXI] [get_bd_intf_pins cvtcolor_bgr2hsv_1/m_axi_gmem1]
connect_bd_intf_net -intf_net [get_bd_intf_nets cvtcolor_bgr2hsv_1_m_axi_gmem1] [get_bd_intf_pins System_DPA/MON_M_AXI] [get_bd_intf_pins axi_ic_ps_e_S_AXI_HP0_FPD/S00_AXI]
  connect_bd_intf_net -intf_net cvtcolor_bgr2hsv_1_m_axi_gmem2 [get_bd_intf_pins axi_ic_ps_e_S_AXI_HP0_FPD/S01_AXI] [get_bd_intf_pins cvtcolor_bgr2hsv_1/m_axi_gmem2]
connect_bd_intf_net -intf_net [get_bd_intf_nets cvtcolor_bgr2hsv_1_m_axi_gmem2] [get_bd_intf_pins System_DPA/MON_M_AXI1] [get_bd_intf_pins axi_ic_ps_e_S_AXI_HP0_FPD/S01_AXI]
  ...
  connect_bd_intf_net -intf_net interconnect_axihpm0fpd_M01_AXI [get_bd_intf_pins System_DPA/S_AXIMM] [get_bd_intf_pins interconnect_axihpm0fpd/M01_AXI]
  connect_bd_intf_net -intf_net interconnect_axilite_M01_AXI [get_bd_intf_pins cvtcolor_bgr2hsv_1/s_axi_control] [get_bd_intf_pins interconnect_axilite/M01_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets interconnect_axilite_M01_AXI] [get_bd_intf_pins System_DPA/MON_S_AXI] [get_bd_intf_pins interconnect_axilite/M01_AXI]
  connect_bd_intf_net -intf_net interconnect_axilite_M02_AXI [get_bd_intf_pins System_DPA/S00_AXI] [get_bd_intf_pins interconnect_axilite/M02_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out4 [get_bd_pins System_DPA/mon_clk] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/S00_ACLK] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/S01_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins cvtcolor_bgr2hsv_1/ap_clk] [get_bd_pins interconnect_axihpm0fpd/M01_ACLK] [get_bd_pins interconnect_axilite/M01_ACLK] [get_bd_pins interconnect_axilite/M02_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps_e/saxihp0_fpd_aclk]
  ...
  connect_bd_net -net cvtcolor_bgr2hsv_1_interrupt [get_bd_pins axi_intc_0_intr_1_interrupt_concat/In1] [get_bd_pins cvtcolor_bgr2hsv_1/interrupt]
  ...
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/S00_ARESETN] [get_bd_pins axi_ic_ps_e_S_AXI_HP0_FPD/S01_ARESETN] [get_bd_pins interconnect_axilite/M01_ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins System_DPA/mon_resetn] [get_bd_pins cvtcolor_bgr2hsv_1/ap_rst_n] [get_bd_pins interconnect_axihpm0fpd/M01_ARESETN] [get_bd_pins interconnect_axilite/M02_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces cvtcolor_bgr2hsv_1/Data_m_axi_gmem1] [get_bd_addr_segs ps_e/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces cvtcolor_bgr2hsv_1/Data_m_axi_gmem2] [get_bd_addr_segs ps_e/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces cvtcolor_bgr2hsv_1/Data_m_axi_gmem1] [get_bd_addr_segs ps_e/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces cvtcolor_bgr2hsv_1/Data_m_axi_gmem2] [get_bd_addr_segs ps_e/SAXIGP2/HP0_QSPI] -force
  ...
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs cvtcolor_bgr2hsv_1/s_axi_control/Reg] -force
  assign_bd_address -offset 0x80010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs System_DPA/dpa_hub/S_AXIFIFO/Reg] -force
  assign_bd_address -offset 0x80030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs System_DPA/dpa_hub/S_AXIHUB/Reg] -force
  assign_bd_address -offset 0x001000000000 -range 0x000200000000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs System_DPA/dpa_hub/S_AXIMM_MAP/S_AXIMM_BLOCK] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces cvtcolor_bgr2hsv_1/Data_m_axi_gmem1] [get_bd_addr_segs ps_e/SAXIGP2/HP0_LPS_OCM]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces cvtcolor_bgr2hsv_1/Data_m_axi_gmem2] [get_bd_addr_segs ps_e/SAXIGP2/HP0_LPS_OCM]
