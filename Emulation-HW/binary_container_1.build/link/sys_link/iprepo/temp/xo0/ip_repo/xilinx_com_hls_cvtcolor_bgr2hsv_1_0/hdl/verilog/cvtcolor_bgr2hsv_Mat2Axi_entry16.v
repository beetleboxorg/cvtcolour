...
module cvtcolor_bgr2hsv_Mat2Axi_entry16 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
assign ap_int_blocking_cur_n = (rows_out_blk_n & rows_out1_blk_n & dout_out_blk_n & cols_out_blk_n & cols_out2_blk_n);
...
assign cols_out_din = cols[26:0];

assign dout_out_din = dout;

assign rows_out1_din = rows;

assign rows_out_din = rows[23:0];

assign start_out = real_start;

endmodule //cvtcolor_bgr2hsv_Mat2Axi_entry16
