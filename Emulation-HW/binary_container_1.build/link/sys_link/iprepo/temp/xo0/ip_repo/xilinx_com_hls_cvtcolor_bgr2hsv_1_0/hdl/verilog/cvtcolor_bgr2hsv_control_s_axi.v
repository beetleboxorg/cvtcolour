...
// ==============================================================
`timescale 1ns/1ps
module cvtcolor_bgr2hsv_control_s_axi
#(parameter
    ...
    output wire [63:0]                   img_bgr,
    output wire [63:0]                   img_hsv,
...
localparam
    ...
    ADDR_IER            = 6'h08,
    ADDR_ISR            = 6'h0c,
    ADDR_IMG_BGR_DATA_0 = 6'h10,
    ADDR_IMG_BGR_DATA_1 = 6'h14,
    ADDR_IMG_BGR_CTRL   = 6'h18,
    ADDR_IMG_HSV_DATA_0 = 6'h1c,
    ADDR_IMG_HSV_DATA_1 = 6'h20,
    ADDR_IMG_HSV_CTRL   = 6'h24,
...
//------------------------Local signal-------------------
    ...
    reg  [63:0]                   int_img_bgr = 'b0;
    reg  [63:0]                   int_img_hsv = 'b0;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_IMG_BGR_DATA_0: begin
                    rdata <= int_img_bgr[31:0];
                end
                ADDR_IMG_BGR_DATA_1: begin
                    rdata <= int_img_bgr[63:32];
                end
                ADDR_IMG_HSV_DATA_0: begin
                    rdata <= int_img_hsv[31:0];
                end
                ADDR_IMG_HSV_DATA_1: begin
                    rdata <= int_img_hsv[63:32];
                end
...
assign img_bgr     = int_img_bgr;
assign img_hsv     = int_img_hsv;
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IMG_BGR_DATA_0)
            int_img_bgr[31:0] <= (WDATA[31:0] & wmask) | (int_img_bgr[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IMG_BGR_DATA_1)
            int_img_bgr[63:32] <= (WDATA[31:0] & wmask) | (int_img_bgr[63:32] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IMG_HSV_DATA_0)
            int_img_hsv[31:0] <= (WDATA[31:0] & wmask) | (int_img_hsv[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IMG_HSV_DATA_1)
            int_img_hsv[63:32] <= (WDATA[31:0] & wmask) | (int_img_hsv[63:32] & ~wmask);
    end
end
