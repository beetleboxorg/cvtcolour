...
set Library     "hls"
set IPName      "cvtcolor_bgr2hsv"
set Version     "1.0"
set DisplayName "Cvtcolor_bgr2hsv"
set Revision    "2104210946"
...
set xo_kernel_name "cvtcolor_bgr2hsv"
set xo_kernel_files {}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/tools/Xilinx/Vitis/2020.1/workspace/cvtcolour/Emulation-HW/binary_container_1.build/cvtcolor_bgr2hsv/cvtcolor_bgr2hsv/cvtcolor_bgr2hsv/solution"
set debug_dir "/tools/Xilinx/Vitis/2020.1/workspace/cvtcolour/Emulation-HW/binary_container_1.build/cvtcolor_bgr2hsv/cvtcolor_bgr2hsv/cvtcolor_bgr2hsv/solution/.debug"
set xo_hls_files_dir ""
set hdl_module_list {cvtcolor_bgr2hsv_mul_27s_27s_27_1_1
cvtcolor_bgr2hsv_mul_32s_32s_32_1_1
cvtcolor_bgr2hsv_fifo_w64_d2_S
cvtcolor_bgr2hsv_fifo_w32_d2_S
cvtcolor_bgr2hsv_fifo_w32_d2_S
cvtcolor_bgr2hsv_fifo_w64_d4_S
cvtcolor_bgr2hsv_fifo_w32_d2_S
cvtcolor_bgr2hsv_fifo_w32_d2_S
cvtcolor_bgr2hsv_fifo_w4_d6_S
cvtcolor_bgr2hsv_fifo_w18_d2_S
cvtcolor_bgr2hsv_fifo_w32_d4_S
cvtcolor_bgr2hsv_fifo_w32_d4_S
cvtcolor_bgr2hsv_fifo_w18_d2_S
cvtcolor_bgr2hsv_fifo_w512_d2_S
cvtcolor_bgr2hsv_start_for_Axi2Mat_entry7_U0
cvtcolor_bgr2hsv_start_for_addrbound4_U0
cvtcolor_bgr2hsv_start_for_AxiStream2MatStream_U0
...
cvtcolor_bgr2hsv_fifo_w4_d2_S
cvtcolor_bgr2hsv_fifo_w32_d2_S_x
cvtcolor_bgr2hsv_fifo_w32_d2_S_x
cvtcolor_bgr2hsv_fifo_w64_d4_S_x
cvtcolor_bgr2hsv_fifo_w24_d2_S
cvtcolor_bgr2hsv_fifo_w32_d2_S_x0
cvtcolor_bgr2hsv_fifo_w27_d2_S
cvtcolor_bgr2hsv_fifo_w32_d2_S_x0
cvtcolor_bgr2hsv_fifo_w18_d2_S_x
cvtcolor_bgr2hsv_fifo_w18_d2_S_x
cvtcolor_bgr2hsv_fifo_w512_d2_S_x
cvtcolor_bgr2hsv_start_for_addrbound_U0
cvtcolor_bgr2hsv_fifo_w32_d2_S_x1
cvtcolor_bgr2hsv_fifo_w32_d2_S_x1
cvtcolor_bgr2hsv_fifo_w32_d4_S_x
cvtcolor_bgr2hsv_fifo_w32_d4_S_x
cvtcolor_bgr2hsv_fifo_w64_d2_S_x
cvtcolor_bgr2hsv_fifo_w64_d4_S_x0
cvtcolor_bgr2hsv_fifo_w24_d2_S_x
cvtcolor_bgr2hsv_fifo_w32_d2_S_x1
cvtcolor_bgr2hsv_fifo_w32_d2_S_x1
cvtcolor_bgr2hsv_fifo_w24_d2_S_x
cvtcolor_bgr2hsv_start_for_xfMat2Array_512_9_1080_1920_1_U0
cvtcolor_bgr2hsv_start_for_bgr2hsv_9_1080_1920_1_U0
...
## Variables
set Top "cvtcolor_bgr2hsv"
set TopNoPrefix "cvtcolor_bgr2hsv"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 img_bgr_1 W 0x0 "Data signal of img_bgr" {{0 32 img_bgr W 0 "Bit 31 to 0 of img_bgr"}}} {0x14 img_bgr_2 W 0x0 "Data signal of img_bgr" {{0 32 img_bgr W 0 "Bit 63 to 32 of img_bgr"}}} {0x1c img_hsv_1 W 0x0 "Data signal of img_hsv" {{0 32 img_hsv W 0 "Bit 31 to 0 of img_hsv"}}} {0x20 img_hsv_2 W 0x0 "Data signal of img_hsv" {{0 32 img_hsv W 0 "Bit 63 to 32 of img_hsv"}}} {0x28 rows W 0x0 "Data signal of rows" {{0 32 rows W 0 "Bit 31 to 0 of rows"}}} {0x30 cols W 0x0 "Data signal of cols" {{0 32 cols W 0 "Bit 31 to 0 of cols"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem1 m_axi_gmem2"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
