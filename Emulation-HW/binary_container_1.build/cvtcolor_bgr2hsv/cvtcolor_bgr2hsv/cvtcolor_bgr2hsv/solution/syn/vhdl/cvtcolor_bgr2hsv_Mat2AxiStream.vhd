...
entity cvtcolor_bgr2hsv_Mat2AxiStream is
port (
...
architecture behav of cvtcolor_bgr2hsv_Mat2AxiStream is 
...
attribute shreg_extract : string;
    signal last_blk_pxl_width13_U0_ap_start : STD_LOGIC;
    signal last_blk_pxl_width13_U0_ap_done : STD_LOGIC;
    signal last_blk_pxl_width13_U0_ap_continue : STD_LOGIC;
    signal last_blk_pxl_width13_U0_ap_idle : STD_LOGIC;
    signal last_blk_pxl_width13_U0_ap_ready : STD_LOGIC;
    signal last_blk_pxl_width13_U0_return_r : STD_LOGIC_VECTOR (3 downto 0);
    signal last_blk_pxl_width13_U0_return_r_ap_vld : STD_LOGIC;
    signal last_blk_pxl_width13_U0_rows_read : STD_LOGIC;
    signal last_blk_pxl_width13_U0_cols_read : STD_LOGIC;
    signal last_blk_pxl_width13_U0_rows_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal last_blk_pxl_width13_U0_rows_out_write : STD_LOGIC;
    signal last_blk_pxl_width13_U0_cols_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal last_blk_pxl_width13_U0_cols_out_write : STD_LOGIC;
    signal last_blk_pxl_width13_U0_ap_ext_blocking_n : STD_LOGIC;
    signal last_blk_pxl_width13_U0_ap_str_blocking_n : STD_LOGIC;
    signal last_blk_pxl_width13_U0_ap_int_blocking_n : STD_LOGIC;
    ...
    signal MatStream2AxiStream_U0_imgOutput0_414_read : STD_LOGIC;
    signal MatStream2AxiStream_U0_ldata1_din : STD_LOGIC_VECTOR (511 downto 0);
    ...
    signal MatStream2AxiStream_U0_ap_ext_blocking_n : STD_LOGIC;
    signal MatStream2AxiStream_U0_ap_str_blocking_n : STD_LOGIC;
    signal MatStream2AxiStream_U0_ap_int_blocking_n : STD_LOGIC;
    ...
    signal ap_sync_reg_last_blk_pxl_width13_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_last_blk_pxl_width13_U0_ap_ready : STD_LOGIC;
    signal last_blk_pxl_width13_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    ...
    signal last_blk_pxl_width13_U0_start_full_n : STD_LOGIC;
    signal last_blk_pxl_width13_U0_start_write : STD_LOGIC;
    ...
    component cvtcolor_bgr2hsv_last_blk_pxl_width13 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component cvtcolor_bgr2hsv_MatStream2AxiStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component cvtcolor_bgr2hsv_fifo_w4_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component cvtcolor_bgr2hsv_fifo_w32_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    last_blk_pxl_width13_U0 : component cvtcolor_bgr2hsv_last_blk_pxl_width13
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    MatStream2AxiStream_U0 : component cvtcolor_bgr2hsv_MatStream2AxiStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    p_channel_U : component cvtcolor_bgr2hsv_fifo_w4_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    rows_c_i_U : component cvtcolor_bgr2hsv_fifo_w32_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    cols_c_i_U : component cvtcolor_bgr2hsv_fifo_w32_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_last_blk_pxl_width13_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_last_blk_pxl_width13_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_last_blk_pxl_width13_U0_ap_ready <= ap_const_logic_0;
                else 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_0 = MatStream2AxiStream_U0_ap_ready) and (ap_sync_ready = ap_const_logic_1))) then 
            ...
            elsif (((ap_const_logic_1 = MatStream2AxiStream_U0_ap_ready) and (ap_sync_ready = ap_const_logic_0))) then 
                MatStream2AxiStream_U0_ap_ready_count <= std_logic_vector(unsigned(MatStream2AxiStream_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;

    last_blk_pxl_width13_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((last_blk_pxl_width13_U0_ap_ready = ap_const_logic_0) and (ap_sync_ready = ap_const_logic_1))) then 
                last_blk_pxl_width13_U0_ap_ready_count <= std_logic_vector(unsigned(last_blk_pxl_width13_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((last_blk_pxl_width13_U0_ap_ready = ap_const_logic_1) and (ap_sync_ready = ap_const_logic_0))) then 
                last_blk_pxl_width13_U0_ap_ready_count <= std_logic_vector(unsigned(last_blk_pxl_width13_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    ap_channel_done_p_channel <= last_blk_pxl_width13_U0_ap_done;
    ap_done <= MatStream2AxiStream_U0_ap_done;
    ap_ext_blocking_cur_n <= ap_const_logic_1;
    ap_ext_blocking_n <= (ap_ext_blocking_sub_n and ap_ext_blocking_cur_n);
    ap_ext_blocking_sub_n <= (last_blk_pxl_width13_U0_ap_ext_blocking_n and MatStream2AxiStream_U0_ap_ext_blocking_n);
    ap_idle <= (last_blk_pxl_width13_U0_ap_idle and (p_channel_empty_n xor ap_const_logic_1) and MatStream2AxiStream_U0_ap_idle);
    ap_int_blocking_cur_n <= ap_const_logic_1;
    ap_int_blocking_n <= (ap_int_blocking_sub_n and ap_int_blocking_cur_n);
    ap_int_blocking_sub_n <= (last_blk_pxl_width13_U0_ap_int_blocking_n and MatStream2AxiStream_U0_ap_int_blocking_n);
    ap_ready <= ap_sync_ready;
    ap_str_blocking_cur_n <= ap_const_logic_1;
    ap_str_blocking_n <= (ap_str_blocking_sub_n and ap_str_blocking_cur_n);
    ap_str_blocking_sub_n <= (last_blk_pxl_width13_U0_ap_str_blocking_n and MatStream2AxiStream_U0_ap_str_blocking_n);
    ...
    ap_sync_last_blk_pxl_width13_U0_ap_ready <= (last_blk_pxl_width13_U0_ap_ready or ap_sync_reg_last_blk_pxl_width13_U0_ap_ready);
    ap_sync_ready <= (ap_sync_last_blk_pxl_width13_U0_ap_ready and ap_sync_MatStream2AxiStream_U0_ap_ready);
    cols_read <= last_blk_pxl_width13_U0_cols_read;
    imgOutput0_414_read <= MatStream2AxiStream_U0_imgOutput0_414_read;
    last_blk_pxl_width13_U0_ap_continue <= p_channel_full_n;
    last_blk_pxl_width13_U0_ap_start <= ((ap_sync_reg_last_blk_pxl_width13_U0_ap_ready xor ap_const_logic_1) and ap_start);
    last_blk_pxl_width13_U0_start_full_n <= ap_const_logic_1;
    last_blk_pxl_width13_U0_start_write <= ap_const_logic_0;
    ldata1_din <= MatStream2AxiStream_U0_ldata1_din;
    ldata1_write <= MatStream2AxiStream_U0_ldata1_write;
    rows_read <= last_blk_pxl_width13_U0_rows_read;
end behav;
