...
# FIFO definition:
set ID 107
set FifoName cvtcolor_bgr2hsv_fifo_w4_d2_S
...
# FIFO definition:
set ID 108
set FifoName cvtcolor_bgr2hsv_fifo_w32_d2_S_x
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ldata1 \
    op interface \
    ports { ldata1_din { O 512 vector } ldata1_full_n { I 1 bit } ldata1_write { O 1 bit } } \
} "
}
