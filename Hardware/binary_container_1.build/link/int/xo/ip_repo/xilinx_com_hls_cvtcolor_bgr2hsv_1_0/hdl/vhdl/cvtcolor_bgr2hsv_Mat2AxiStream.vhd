...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_sync_ready = ap_const_logic_1) and (last_blk_pxl_width13_U0_ap_ready = ap_const_logic_0))) then 
            ...
            elsif (((ap_sync_ready = ap_const_logic_0) and (last_blk_pxl_width13_U0_ap_ready = ap_const_logic_1))) then 
                last_blk_pxl_width13_U0_ap_ready_count <= std_logic_vector(unsigned(last_blk_pxl_width13_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
